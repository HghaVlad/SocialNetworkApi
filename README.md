# Social Network Api service with DRF
Решение задачи со второго этапа олимпиады [PROD](https://prodcontest.ru)
...
В папке tests тесты написанные на requests. Ниже описание задания.
...
<details>
<summary> Приложение конфигурируется через переменные окружения: </summary>
